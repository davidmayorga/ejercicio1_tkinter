...
def sumar():
    ...
    t_resultados.insert(INSERT, "El IVA de " + a.get() + " casi siempre es " + str(c)+"\n")
    t_resultados.insert(INSERT, "El total" + a.get() + " casi siempre es " + str(d)+"\n")
def borrar():
...
etiq_a = Label(frame_entrada, text="Ingrese el precio : ")
